  ...
  return (
    <div className="flex flex-col rounded-xl border border-white/[0.07] bg-white/[0.015] overflow-hidden h-full">
      ...
      <div className="px-4 pt-4 pb-3 border-b border-white/[0.06]">
        <h2 className="text-xs font-semibold text-white/75 mb-1">AI Design Insights</h2>
...
function StatPill({
  ...
  return (
    <div className="flex flex-col items-center gap-0.5 px-3 py-2 rounded-lg border border-white/[0.07] bg-white/[0.02]">
      <span className={`text-lg font-bold tabular-nums ${numCls}`}>{value}</span>
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center justify-between">
        ...
        <span className={`text-[11px] font-bold tabular-nums ${scoreColor(value)}`}>
          {value}
        </span>
      </div>
...
function DiffBar({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-[10px] text-white/30 w-10 flex-shrink-0">{label}</span>
      ...
      <span className="text-[9px] text-white/25 w-6 text-right tabular-nums">{count}</span>
    </div>
  );
}
